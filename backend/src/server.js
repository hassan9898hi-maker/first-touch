...
// Production defaults (Render.com)
if (!process.env.DATABASE_URL) {
  process.env.DATABASE_URL = "postgresql://hassn:ToThVIcyPQMtKnbBmN0djaFAi7whALWd@dpg-d74ht0dm5p6s73f7hlng-a.frankfurt-postgres.render.com/hassan_37fy";
}
